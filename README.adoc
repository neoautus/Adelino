...
Adelino X1 is the first version of the board, aimed to test integration, assemblying process, firmware and the overall concept. This PCB was assembled by SeeedStudio.
