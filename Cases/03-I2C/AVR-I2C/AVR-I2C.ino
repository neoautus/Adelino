...
// Test I2C from AVR by scanning available devices.
//
// This uses the default Wire library and default config
// (pins D2->SDA and D3->SCL). Scans all available devices
// plugged into I2C bus and print their addresses, every
// 5 seconds. 
//
...
void setup() 
{
  ...
  // Init wire library (default pins D2 and D3)
  Wire.begin ();
}
